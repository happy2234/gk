...
export default function NotFound() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-24 flex flex-col items-start animate-fade-in">
      <p className="text-[12px] font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-3">
        404
      </p>
      <h1
      ...
      <p className="text-[17px] text-gray-500 dark:text-gray-400 mb-8 max-w-[50ch] leading-relaxed">
